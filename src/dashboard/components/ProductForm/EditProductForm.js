...
const EditProductForm = ({
	...
	const [unit, setUnit] = useState([...state['types'][0]['unit']]);
	...
	const handleSubmit = () => {
		...
		toast.promise(apiCall("post", formData, "/product/update", onSuccess, onFailure), {
			pending: "updating....",
		});
	};
								...
								<Row form>
									...
									<Col md='6' className='form-group'>
										...
										<Creatable
											...
											isMulti
											options={options}
											defaultValue={[...data['catagories'].map(el=>{return { label: el, value:el };})]}
												...
												<tr>
													...
													<td>
														...
														<Button
															...
															onClick={(e) => {
																e.preventDefault();
																console.log(data["types"].indexOf(el));
																setTypes(el);
																setImages(el["images"]);
																setUnit(el["unit"]);
															}}
